!async function() {
    ...
    function v(t, e) {
        ...
        await (async () => new Promise(t => {
        ...
        }))(), null !== g ? g.append(l) : document.querySelector('form[action="/cart/add"]').after(l), fetch("https://us-central1-trust-pitcher.cloudfunctions.net/merchant-visitor-counter", {
            method: "POST",
            mode: "cors",
            cache: "no-cache",
            headers: {
            ...
            body: JSON.stringify({
                shopName: "dohashopiy.myshopify.com"
            })
